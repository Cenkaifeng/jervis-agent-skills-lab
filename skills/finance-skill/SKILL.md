---
name: finance-skill
description: Personal finance memory layer for parsing statement PDFs/images, normalizing transactions, and answering spending queries. Use when users ask to ingest statements, add transactions, or analyze personal spending by date/category/merchant.
---
